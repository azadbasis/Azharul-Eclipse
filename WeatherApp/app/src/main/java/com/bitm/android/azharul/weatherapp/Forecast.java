...
public class Forecast extends Activity {
    ...
    String forecast_url = "http://api.openweathermap.org/data/2.5/find?q=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String appID="712d6a441dab8d24204e5eceaa6a5ceb";
    ...
    public void makejsonreq(String url) {
        ...
        PD.show();
        JsonObjectRequest jsonObjReqq=new JsonObjectRequest(Method.GET, forecast_url, new Response.Listener<JSONObject>() {
            @Override
